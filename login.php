...
<html lang="en">
    ...
    <body>
    <nav id="nav">
        <div id="button" class="buttonr"><img src="moevan icons\fi-br-menu-burger.svg" alt=""></div>
...
<form method="post" id="form">
        ...
        <div class="middle-part">
            ...
            <input class="form-control" id="email" name="uemail" type="email" placeholder="username or email" required />
        ...
        <div class="last-part">
            <a href="password-recovery.php"><p class="orange">forgot password</p></a>
            <button name="login" type="submit"><h5>log in</h5></button>
        </div>

        <div class="very-last">
            <p>...not yet registered</p>
            <button><a href="signup.php" class="a"><h5>Create free Account</h5></a></button>
        </div>
